...
/* api/index.html.twig */
class __TwigTemplate_74d14f75082701f3d0cabcefd88e372c79bf56f7c97347fd320441c6ca64a959 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<p class=\"card-text\">Nombre de personnes actuellement hospitalisée</p>
\t\t\t\t\t\t</div>
                        <h3 class=\"card-footer bg-warning text-dark mx-2 rounded-pill\">Prix du BTC en EUR : {{ response.data|filter(_ => _.symbol == 'BTC')|map(_ => _.quote.EUR.price)|join() }} €</h3>
\t\t\t\t\t</div>
\t\t\t\t</div>
                <div class=\"col\">
\t\t\t\t\t<div class=\"card shadow-sm\">
