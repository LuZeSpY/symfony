...
/* accueil.html.twig */
class __TwigTemplate_3c8f02bd32b3018d51bc334813fa627872c574f3a8b647bd9f10bbafbac66030 extends Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <body>
        <h1>{{ title }}</h1>
\t  {# Cette ligne ci-dessous n'est présente que dans accueil.html.twig #}
        <p>{{ content }}</p>
    </body>
